...
class Vehicle:
    def __init__(self, pos: Tuple[float, float], hitch_offset_x: int, hitch_offset_y: int) -> None:
        self.width: int = 20
        self.height: int = 20

        self.rect: pg.Rect = pg.Rect(pos[0], pos[1], 0, 0)
        self.x: float = pos[0]
        self.y: float = pos[1]
        self.update_rect()
...
class Trailer:
    def __init__(self, vehicle: Vehicle, pos: Tuple[float, float], hitch_offset_x: int, hitch_offset_y: int) -> None:
